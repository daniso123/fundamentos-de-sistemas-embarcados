...
class ServidorCentral:
        ...
        while True:
            try:
                ...
                if mensagem['from'] == 'Client 1':
                    self.tratar_mensagem_client1(mensagem)
                elif mensagem['from'] == 'Client 2':
                    self.tratar_mensagem_client2(mensagem)
                else:
                    self.tratar_mensagem_outros_clientes(mensagem)
    ...
    def tratar_mensagem_client1(self, mensagem):
    ...
    def tratar_mensagem_client2(self, mensagem):
        global carros_andar1, sinal1, vagas1, carros_andar2, sinal2, vagas2, total_carros, id_carro
    ...
    def tratar_mensagem_outros_clientes(self, mensagem):
        global carros_andar1, sinal1, vagas1, carros_andar2, sinal2, vagas2, total_carros, id_carro
        carros_andar2 = mensagem['message'][0].get('carros_andar2', 0)
        sinal2 = mensagem['message'][0].get('sinal2')
        vagas2 = mensagem['message'][0].get('vagas')
